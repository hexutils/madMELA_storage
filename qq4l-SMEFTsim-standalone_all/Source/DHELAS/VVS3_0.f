...
C     
      ...
      P2(2) = DIMAG(V2(2))
      P2(3) = DIMAG(V2(1))
      TMP29 = (-1D0)*(P1(0)*(P2(1)*(V2(5)*V1(6)-V2(6)*V1(5))+(P2(2)*(
     ...
     $ *(V2(4)*V1(6)-V2(6)*V1(4))+(P2(1)*(-V2(3)*V1(6)+V2(6)*V1(3))
     $ +P2(3)*(V2(3)*V1(4)-V2(4)*V1(3))))+P1(3)*(P2(0)*(-V2(4)*V1(5)
     $ +V2(5)*V1(4))+(P2(1)*(V2(3)*V1(5)-V2(5)*V1(3))+P2(2)*(-V2(3)
     $ *V1(4)+V2(4)*V1(3)))))))
      TMP30 = (-1D0)*(P1(0)*(P2(1)*(-V2(5)*V1(6)+V2(6)*V1(5))+(P2(2)
     $ *(V2(4)*V1(6)-V2(6)*V1(4))+P2(3)*(-V2(4)*V1(5)+V2(5)*V1(4))))
     $ +(P1(1)*(P2(0)*(V2(5)*V1(6)-V2(6)*V1(5))+(P2(2)*(-V2(3)*V1(6)
     $ +V2(6)*V1(3))+P2(3)*(V2(3)*V1(5)-V2(5)*V1(3))))+(P1(2)*(P2(0)*(
     ...
     $ -V2(4)*V1(3)))))))
      VERTEX = COUP*S3(3)*(+CI*(TMP29)-CI*(TMP30))
      END
