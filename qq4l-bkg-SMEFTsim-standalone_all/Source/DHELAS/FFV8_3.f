...
C     
      ...
      P3(2) = -DIMAG(V3(2))
      P3(3) = -DIMAG(V3(1))
      TMP11 = (F1(3)*-F2(3)*(-P3(0)*P3(0)+P3(1)*P3(1)+P3(2)*P3(2)+P3(3)
     ...
     $ *P3(2)+P3(3)*P3(3)))))
      TMP12 = (F1(3)*-F2(3)*(-P3(0)*P3(0)+P3(1)*P3(1)+P3(2)*P3(2)+P3(3)
     $ *P3(3))-F1(4)*F2(4)*(-P3(0)*P3(0)+P3(1)*P3(1)+P3(2)*P3(2)+P3(3)
     $ *P3(3)))
      TMP13 = (F1(5)*-F2(5)*(-P3(0)*P3(0)+P3(1)*P3(1)+P3(2)*P3(2)+P3(3)
     ...
     $ -F2(4)*F1(4)-F2(5)*F1(5))+1D0/2D0*(OM3*P3(0)*(-TMP11+TMP12
     $ +TMP13)))))
     ...
     $ +F2(4)*F1(3)+F2(6)*F1(5))+1D0/2D0*(OM3*P3(1)*(-TMP11+TMP12
     $ +TMP13)))))
     ...
     $ -1D0/2D0*(OM3*P3(2)*(-CI*(TMP11)+CI*(TMP12+TMP13))))))
     ...
     $ +F2(6)*F1(5)))-1D0/2D0*(OM3*P3(3)*(-TMP11+TMP12+TMP13)))))
      END
