...
C     
      ...
      P3(2) = -DIMAG(V3(2))
      P3(3) = -DIMAG(V3(1))
      TMP20 = (-1D0)*(F1(3)*-F2(3)*(-P3(0)*P3(0)+P3(1)*P3(1)+P3(2)
     ...
     $ +P3(2)*P3(2)+P3(3)*P3(3)))))
      TMP21 = (-1D0)*(F1(3)*-F2(3)*(-P3(0)*P3(0)+P3(1)*P3(1)+P3(2)
     $ *P3(2)+P3(3)*P3(3))+(F1(4)*-F2(4)*(-P3(0)*P3(0)+P3(1)*P3(1)
     $ +P3(2)*P3(2)+P3(3)*P3(3))+(F1(5)*F2(5)*(-P3(0)*P3(0)+P3(1)*P3(1)
     $ +P3(2)*P3(2)+P3(3)*P3(3))+F1(6)*F2(6)*(-P3(0)*P3(0)+P3(1)*P3(1)
     $ +P3(2)*P3(2)+P3(3)*P3(3)))))
     ...
     $ -F2(6)*F1(6))+1D0/2D0*(OM3*P3(0)*(-TMP20+TMP21)))))
     ...
     $ -F2(6)*F1(5))+1D0/2D0*(OM3*P3(1)*(-TMP20+TMP21)))))
     ...
     $ +1D0/2D0*(OM3*P3(2)*(+CI*(TMP20)-CI*(TMP21))))))
     ...
     $ +F2(5)*F1(6)))+1D0/2D0*(OM3*P3(3)*(-TMP20+TMP21)))))
      END
