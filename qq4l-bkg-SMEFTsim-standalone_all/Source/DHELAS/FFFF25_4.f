...
C     ojP(-5,3)*ProjP(-3,1)
C     
      SUBROUTINE FFFF25_4(F1, F2, F3, COUP, M4, W4,F4)
      IMPLICIT NONE
      COMPLEX*16 CI
     ...
     $ -F2(6)*F3(6)*(P4(1)+CI*(P4(2))))+F1(6)*(F2(5)*F3(5)*(P4(0)+P4(3)
     $ )+F2(6)*F3(6)*(P4(0)+P4(3))))
      F4(5)= DENOM*16D0 * CI * F1(5)*M4*(F3(5)*F2(5)+F3(6)*F2(6))
      F4(6)= DENOM*16D0 * CI * F1(6)*M4*(F3(5)*F2(5)+F3(6)*F2(6))
      END
