...
C     *   Decay: h > e+ e- mu+ mu- NP<=1 SMHLOOP=0
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 24
     ...
     $ ,GC_229,AMP(24))
      CALL FFV5_3(W(1,3),W(1,4),GC_352,MDL_MZ,MDL_WZ,W(1,6))
      CALL VVS4_3(W(1,6),W(1,8),GC_285,MDL_MH,MDL_WH,W(1,10))
C     Amplitude(s) for diagram number 25
      CALL VVS6_7_8_9_0(W(1,1),W(1,2),W(1,10),GC_225,GC_234,GC_238
     $ ,GC_229,AMP(25))
      CALL FFV8_3(W(1,3),W(1,4),GC_709,MDL_MZ,MDL_WZ,W(1,10))
      CALL VVS4_3(W(1,10),W(1,8),GC_285,MDL_MH,MDL_WH,W(1,6))
C     Amplitude(s) for diagram number 26
      CALL VVS6_7_8_9_0(W(1,1),W(1,2),W(1,6),GC_225,GC_234,GC_238
     $ ,GC_229,AMP(26))
      CALL FFV2_3(W(1,3),W(1,4),GC_708,MDL_MZ,MDL_WZ,W(1,6))
      CALL VVS4_3(W(1,6),W(1,8),GC_285,MDL_MH,MDL_WH,W(1,10))
...
C     Amplitude(s) for diagram number 28
      CALL VVS6_7_8_9_0(W(1,1),W(1,2),W(1,6),GC_225,GC_234,GC_238
     $ ,GC_229,AMP(28))
      CALL FFV3_3(W(1,3),W(1,4),GC_353,MDL_MZ,MDL_WZ,W(1,6))
      CALL VVS4_3(W(1,6),W(1,8),GC_285,MDL_MH,MDL_WH,W(1,10))
...
C     Amplitude(s) for diagram number 30
      CALL VVS6_7_8_9_0(W(1,1),W(1,2),W(1,6),GC_225,GC_234,GC_238
     $ ,GC_229,AMP(30))
      CALL FFV8_3(W(1,3),W(1,4),GC_719,MDL_MZ,MDL_WZ,W(1,6))
      CALL VVS4_3(W(1,6),W(1,8),GC_285,MDL_MH,MDL_WH,W(1,10))
...
C     Amplitude(s) for diagram number 32
      CALL VVS6_7_8_9_0(W(1,1),W(1,2),W(1,6),GC_225,GC_234,GC_238
     $ ,GC_229,AMP(32))
      CALL FFV1_3(W(1,3),W(1,4),GC_395,MDL_MZ,MDL_WZ,W(1,6))
      CALL VVS4_3(W(1,6),W(1,8),GC_285,MDL_MH,MDL_WH,W(1,10))
...
C     Amplitude(s) for diagram number 34
      CALL VVS6_7_8_9_0(W(1,1),W(1,2),W(1,6),GC_225,GC_234,GC_238
     $ ,GC_229,AMP(34))
      CALL FFV5_3(W(1,3),W(1,4),GC_398,MDL_MZ,MDL_WZ,W(1,6))
      CALL VVS4_3(W(1,6),W(1,8),GC_285,MDL_MH,MDL_WH,W(1,10))
C     Amplitude(s) for diagram number 35
      CALL VVS6_7_8_9_0(W(1,1),W(1,2),W(1,10),GC_225,GC_234,GC_238
     $ ,GC_229,AMP(35))
      CALL FFV3_3(W(1,3),W(1,4),GC_387,MDL_MZ,MDL_WZ,W(1,10))
      CALL VVS4_3(W(1,10),W(1,8),GC_285,MDL_MH,MDL_WH,W(1,4))
C     Amplitude(s) for diagram number 36
      CALL VVS6_7_8_9_0(W(1,1),W(1,2),W(1,4),GC_225,GC_234,GC_238
     $ ,GC_229,AMP(36))
