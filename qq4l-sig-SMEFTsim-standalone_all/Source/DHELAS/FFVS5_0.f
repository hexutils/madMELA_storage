...
C     
      ...
      P3(2) = DIMAG(V3(2))
      P3(3) = DIMAG(V3(1))
      TMP10 = (F1(3)*(F2(3)*(P3(0)*(V3(3)-V3(6))+(P3(1)*(-V3(4)+CI
     ...
     $ *(V3(3)-V3(6)))))))))
      TMP11 = (F1(3)*(F2(3)*(P3(0)*(V3(3)+V3(6))+(P3(1)*(-1D0)*(V3(4)
     ...
     $ -1D0)*(+CI*(V3(4))+V3(5))+P3(3)*(V3(3)-V3(6)))))))
      TMP12 = (F1(5)*(F2(5)*(P3(0)*(V3(3)-V3(6))+(P3(1)*(-1D0)*(V3(4)
     $ +CI*(V3(5)))+(P3(2)*(+CI*(V3(4))-V3(5))+P3(3)*(V3(3)-V3(6)))))
     ...
     $ -1D0)*(+CI*(V3(4))+V3(5))-P3(3)*(V3(3)+V3(6)))))))
      VERTEX = COUP*S4(3)*(-CI*(TMP10)+CI*(TMP11+TMP12))
      END
