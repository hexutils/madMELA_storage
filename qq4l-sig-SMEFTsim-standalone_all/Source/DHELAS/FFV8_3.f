...
C     
     ...
     $ *P3(2)+P3(3)*P3(3)))))
      TMP20 = (F1(3)*-F2(3)*(-P3(0)*P3(0)+P3(1)*P3(1)+P3(2)*P3(2)+P3(3)
     $ *P3(3))-F1(4)*F2(4)*(-P3(0)*P3(0)+P3(1)*P3(1)+P3(2)*P3(2)+P3(3)
     $ *P3(3)))
      TMP21 = (F1(5)*-F2(5)*(-P3(0)*P3(0)+P3(1)*P3(1)+P3(2)*P3(2)+P3(3)
     ...
     $ -F2(4)*F1(4)-F2(5)*F1(5))+1D0/2D0*(OM3*P3(0)*(-TMP19+TMP20
     $ +TMP21)))))
     ...
     $ +F2(4)*F1(3)+F2(6)*F1(5))+1D0/2D0*(OM3*P3(1)*(-TMP19+TMP20
     $ +TMP21)))))
     ...
     $ -1D0/2D0*(OM3*P3(2)*(-CI*(TMP19)+CI*(TMP20+TMP21))))))
     ...
     $ +F2(6)*F1(5)))-1D0/2D0*(OM3*P3(3)*(-TMP19+TMP20+TMP21)))))
      END
