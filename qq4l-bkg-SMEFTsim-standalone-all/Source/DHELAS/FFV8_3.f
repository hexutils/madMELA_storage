...
C     
      ...
      P3(2) = -DIMAG(V3(2))
      P3(3) = -DIMAG(V3(1))
      TMP10 = (F1(3)*-F2(3)*(-P3(0)*P3(0)+P3(1)*P3(1)+P3(2)*P3(2)+P3(3)
     $ *P3(3))-F1(4)*F2(4)*(-P3(0)*P3(0)+P3(1)*P3(1)+P3(2)*P3(2)+P3(3)
     $ *P3(3)))
      TMP11 = (F1(5)*-F2(5)*(-P3(0)*P3(0)+P3(1)*P3(1)+P3(2)*P3(2)+P3(3)
     ...
     $ *(F2(4)*F1(3)+F2(5)*F1(6)))+(P3(3)*(F2(3)*F1(3)+F2(6)*F1(6)
     $ -F2(4)*F1(4)-F2(5)*F1(5))+1D0/2D0*(OM3*P3(0)*(-TMP9+TMP10+TMP11)
     $ ))))
     ...
     $ +F2(4)*F1(3)+F2(6)*F1(5))+1D0/2D0*(OM3*P3(1)*(-TMP9+TMP10+TMP11)
     $ ))))
     ...
     $ -1D0/2D0*(OM3*P3(2)*(-CI*(TMP9)+CI*(TMP10+TMP11))))))
     ...
     $ +F2(6)*F1(5)))-1D0/2D0*(OM3*P3(3)*(-TMP9+TMP10+TMP11)))))
      END
