...
C     Amplitude(s) for diagram number 32
      ...
      CALL FFV1_2(W(1,1),W(1,8),GC_2,MDL_MU,ZERO,W(1,9))
C     Amplitude(s) for diagram number 33
      CALL FFV1_0(W(1,9),W(1,2),W(1,14),GC_2,AMP(33))
      CALL FFV1_2(W(1,1),W(1,14),GC_2,MDL_MU,ZERO,W(1,3))
...
C     Amplitude(s) for diagram number 35
      ...
      CALL FFV1_3_2(W(1,1),W(1,12),GC_196,GC_135,MDL_MU,ZERO,W(1,9))
...
C     Amplitude(s) for diagram number 40
      ...
      CALL FFV1_2(W(1,1),W(1,15),GC_2,MDL_MU,ZERO,W(1,9))
C     Amplitude(s) for diagram number 41
      CALL FFV1_0(W(1,9),W(1,2),W(1,13),GC_2,AMP(41))
      CALL FFV1_2(W(1,1),W(1,13),GC_2,MDL_MU,ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 43
      ...
      CALL FFV1_3_2(W(1,1),W(1,7),GC_196,GC_135,MDL_MU,ZERO,W(1,9))
C     Amplitude(s) for diagram number 44
      CALL FFV1_0(W(1,9),W(1,2),W(1,15),GC_2,AMP(44))
      CALL FFV1_3_2(W(1,1),W(1,17),GC_196,GC_135,MDL_MU,ZERO,W(1,15))
