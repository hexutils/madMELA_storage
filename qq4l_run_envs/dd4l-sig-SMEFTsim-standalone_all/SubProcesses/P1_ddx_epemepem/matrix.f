...
C     
C     Process: d d~ > e+ e- e+ e- WEIGHTED<=8 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 4
      ...
      CALL FFS2_3(W(1,1),W(1,2),GC_602,MDL_MH,MDL_WH,W(1,14))
...
C     Amplitude(s) for diagram number 48
      ...
      CALL FFV1_2(W(1,1),W(1,15),GC_1,MDL_MD,ZERO,W(1,23))
C     Amplitude(s) for diagram number 49
      CALL FFS2_0(W(1,23),W(1,2),W(1,19),GC_602,AMP(49))
      CALL FFS2_2(W(1,1),W(1,19),GC_602,MDL_MD,ZERO,W(1,23))
C     Amplitude(s) for diagram number 50
      CALL FFV1_0(W(1,23),W(1,2),W(1,15),GC_1,AMP(50))
      CALL FFV1_3_2(W(1,1),W(1,18),GC_195,-GC_135,MDL_MD,ZERO,W(1,15))
C     Amplitude(s) for diagram number 51
      CALL FFS2_0(W(1,15),W(1,2),W(1,19),GC_602,AMP(51))
C     Amplitude(s) for diagram number 52
      CALL FFV1_3_0(W(1,23),W(1,2),W(1,18),GC_195,-GC_135,AMP(52))
      CALL FFS2_2(W(1,1),W(1,8),GC_602,MDL_MD,ZERO,W(1,18))
C     Amplitude(s) for diagram number 53
      CALL FFV1_0(W(1,18),W(1,2),W(1,9),GC_1,AMP(53))
      CALL FFV1_2(W(1,1),W(1,9),GC_1,MDL_MD,ZERO,W(1,15))
C     Amplitude(s) for diagram number 54
      CALL FFS2_0(W(1,15),W(1,2),W(1,8),GC_602,AMP(54))
...
C     Amplitude(s) for diagram number 56
      CALL FFS2_0(W(1,15),W(1,2),W(1,8),GC_602,AMP(56))
C     Amplitude(s) for diagram number 57
      CALL FFS2_0(W(1,18),W(1,2),W(1,19),GC_602,AMP(57))
C     Amplitude(s) for diagram number 58
      CALL FFS2_0(W(1,23),W(1,2),W(1,8),GC_602,AMP(58))
      CALL FFV1_2(W(1,1),W(1,12),GC_1,MDL_MD,ZERO,W(1,23))
C     Amplitude(s) for diagram number 59
      CALL FFS2_0(W(1,23),W(1,2),W(1,16),GC_602,AMP(59))
      CALL FFS2_2(W(1,1),W(1,16),GC_602,MDL_MD,ZERO,W(1,23))
C     Amplitude(s) for diagram number 60
      CALL FFV1_0(W(1,23),W(1,2),W(1,12),GC_1,AMP(60))
      CALL FFV1_3_2(W(1,1),W(1,24),GC_195,-GC_135,MDL_MD,ZERO,W(1,12))
C     Amplitude(s) for diagram number 61
      CALL FFS2_0(W(1,12),W(1,2),W(1,16),GC_602,AMP(61))
C     Amplitude(s) for diagram number 62
      CALL FFV1_3_0(W(1,23),W(1,2),W(1,24),GC_195,-GC_135,AMP(62))
      CALL FFS2_2(W(1,1),W(1,21),GC_602,MDL_MD,ZERO,W(1,24))
C     Amplitude(s) for diagram number 63
      CALL FFV1_0(W(1,24),W(1,2),W(1,13),GC_1,AMP(63))
      CALL FFV1_2(W(1,1),W(1,13),GC_1,MDL_MD,ZERO,W(1,12))
C     Amplitude(s) for diagram number 64
      CALL FFS2_0(W(1,12),W(1,2),W(1,21),GC_602,AMP(64))
C     Amplitude(s) for diagram number 65
      CALL FFV1_3_0(W(1,24),W(1,2),W(1,25),GC_195,-GC_135,AMP(65))
      CALL FFV1_3_2(W(1,1),W(1,25),GC_195,-GC_135,MDL_MD,ZERO,W(1,12))
C     Amplitude(s) for diagram number 66
      CALL FFS2_0(W(1,12),W(1,2),W(1,21),GC_602,AMP(66))
C     Amplitude(s) for diagram number 67
      CALL FFS2_0(W(1,24),W(1,2),W(1,16),GC_602,AMP(67))
C     Amplitude(s) for diagram number 68
      CALL FFS2_0(W(1,23),W(1,2),W(1,21),GC_602,AMP(68))
