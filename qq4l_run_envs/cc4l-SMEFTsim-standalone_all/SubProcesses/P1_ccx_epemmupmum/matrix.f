...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV1_3_3(W(1,1),W(1,2),GC_196,GC_135,MDL_MZ,MDL_WZ,W(1,10))
...
C     Amplitude(s) for diagram number 12
      ...
      CALL FFS2_3(W(1,1),W(1,2),GC_526,MDL_MH,MDL_WH,W(1,13))
...
C     Amplitude(s) for diagram number 40
      ...
      CALL FFV1_2(W(1,1),W(1,8),GC_2,MDL_MC,ZERO,W(1,5))
C     Amplitude(s) for diagram number 41
      CALL FFV1_0(W(1,5),W(1,2),W(1,15),GC_2,AMP(41))
      CALL FFV1_2(W(1,1),W(1,15),GC_2,MDL_MC,ZERO,W(1,3))
C     Amplitude(s) for diagram number 42
      CALL FFV1_0(W(1,3),W(1,2),W(1,8),GC_2,AMP(42))
C     Amplitude(s) for diagram number 43
      CALL FFV1_3_0(W(1,5),W(1,2),W(1,9),GC_196,GC_135,AMP(43))
      CALL FFV1_3_2(W(1,1),W(1,9),GC_196,GC_135,MDL_MC,ZERO,W(1,6))
C     Amplitude(s) for diagram number 44
      CALL FFV1_0(W(1,6),W(1,2),W(1,8),GC_2,AMP(44))
C     Amplitude(s) for diagram number 45
      CALL FFS2_0(W(1,5),W(1,2),W(1,14),GC_526,AMP(45))
      CALL FFS2_2(W(1,1),W(1,14),GC_526,MDL_MC,ZERO,W(1,5))
C     Amplitude(s) for diagram number 46
      CALL FFV1_0(W(1,5),W(1,2),W(1,8),GC_2,AMP(46))
      CALL FFV1_3_2(W(1,1),W(1,11),GC_196,GC_135,MDL_MC,ZERO,W(1,8))
C     Amplitude(s) for diagram number 47
      CALL FFV1_0(W(1,8),W(1,2),W(1,15),GC_2,AMP(47))
C     Amplitude(s) for diagram number 48
      CALL FFV1_3_0(W(1,3),W(1,2),W(1,11),GC_196,GC_135,AMP(48))
C     Amplitude(s) for diagram number 49
      CALL FFV1_3_0(W(1,8),W(1,2),W(1,9),GC_196,GC_135,AMP(49))
C     Amplitude(s) for diagram number 50
      CALL FFV1_3_0(W(1,6),W(1,2),W(1,11),GC_196,GC_135,AMP(50))
C     Amplitude(s) for diagram number 51
      CALL FFS2_0(W(1,8),W(1,2),W(1,14),GC_526,AMP(51))
C     Amplitude(s) for diagram number 52
      CALL FFV1_3_0(W(1,5),W(1,2),W(1,11),GC_196,GC_135,AMP(52))
      CALL FFS2_2(W(1,1),W(1,12),GC_526,MDL_MC,ZERO,W(1,11))
C     Amplitude(s) for diagram number 53
      CALL FFV1_0(W(1,11),W(1,2),W(1,15),GC_2,AMP(53))
C     Amplitude(s) for diagram number 54
      CALL FFS2_0(W(1,3),W(1,2),W(1,12),GC_526,AMP(54))
C     Amplitude(s) for diagram number 55
      CALL FFV1_3_0(W(1,11),W(1,2),W(1,9),GC_196,GC_135,AMP(55))
C     Amplitude(s) for diagram number 56
      CALL FFS2_0(W(1,6),W(1,2),W(1,12),GC_526,AMP(56))
C     Amplitude(s) for diagram number 57
      CALL FFS2_0(W(1,11),W(1,2),W(1,14),GC_526,AMP(57))
C     Amplitude(s) for diagram number 58
      CALL FFS2_0(W(1,5),W(1,2),W(1,12),GC_526,AMP(58))
