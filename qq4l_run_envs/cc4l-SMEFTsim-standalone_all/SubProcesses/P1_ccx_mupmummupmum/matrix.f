...
C     Amplitude(s) for diagram number 12
      ...
      CALL FFS2_3(W(1,1),W(1,2),GC_526,MDL_MH,MDL_WH,W(1,16))
...
C     Amplitude(s) for diagram number 80
      ...
      CALL FFV1_2(W(1,1),W(1,8),GC_2,MDL_MC,ZERO,W(1,14))
C     Amplitude(s) for diagram number 81
      CALL FFV1_0(W(1,14),W(1,2),W(1,18),GC_2,AMP(81))
      CALL FFV1_2(W(1,1),W(1,18),GC_2,MDL_MC,ZERO,W(1,3))
...
C     Amplitude(s) for diagram number 83
      ...
      CALL FFV1_3_2(W(1,1),W(1,20),GC_196,GC_135,MDL_MC,ZERO,W(1,15))
C     Amplitude(s) for diagram number 84
      CALL FFV1_0(W(1,15),W(1,2),W(1,8),GC_2,AMP(84))
C     Amplitude(s) for diagram number 85
      CALL FFS2_0(W(1,14),W(1,2),W(1,19),GC_526,AMP(85))
      CALL FFS2_2(W(1,1),W(1,19),GC_526,MDL_MC,ZERO,W(1,14))
...
C     Amplitude(s) for diagram number 96
      CALL FFS2_0(W(1,15),W(1,2),W(1,12),GC_526,AMP(96))
C     Amplitude(s) for diagram number 97
      CALL FFS2_0(W(1,11),W(1,2),W(1,19),GC_526,AMP(97))
C     Amplitude(s) for diagram number 98
      CALL FFS2_0(W(1,14),W(1,2),W(1,12),GC_526,AMP(98))
      CALL FFV1_2(W(1,1),W(1,21),GC_2,MDL_MC,ZERO,W(1,14))
C     Amplitude(s) for diagram number 99
      CALL FFV1_0(W(1,14),W(1,2),W(1,26),GC_2,AMP(99))
      CALL FFV1_2(W(1,1),W(1,26),GC_2,MDL_MC,ZERO,W(1,12))
...
C     Amplitude(s) for diagram number 101
      ...
      CALL FFV1_3_2(W(1,1),W(1,25),GC_196,GC_135,MDL_MC,ZERO,W(1,11))
C     Amplitude(s) for diagram number 102
      CALL FFV1_0(W(1,11),W(1,2),W(1,21),GC_2,AMP(102))
C     Amplitude(s) for diagram number 103
      CALL FFS2_0(W(1,14),W(1,2),W(1,17),GC_526,AMP(103))
      CALL FFS2_2(W(1,1),W(1,17),GC_526,MDL_MC,ZERO,W(1,14))
C     Amplitude(s) for diagram number 104
      CALL FFV1_0(W(1,14),W(1,2),W(1,21),GC_2,AMP(104))
      CALL FFV1_3_2(W(1,1),W(1,23),GC_196,GC_135,MDL_MC,ZERO,W(1,21))
...
C     Amplitude(s) for diagram number 109
      CALL FFS2_0(W(1,21),W(1,2),W(1,17),GC_526,AMP(109))
...
C     Amplitude(s) for diagram number 112
      CALL FFS2_0(W(1,12),W(1,2),W(1,24),GC_526,AMP(112))
...
C     Amplitude(s) for diagram number 114
      CALL FFS2_0(W(1,11),W(1,2),W(1,24),GC_526,AMP(114))
C     Amplitude(s) for diagram number 115
      CALL FFS2_0(W(1,23),W(1,2),W(1,17),GC_526,AMP(115))
C     Amplitude(s) for diagram number 116
      CALL FFS2_0(W(1,14),W(1,2),W(1,24),GC_526,AMP(116))
