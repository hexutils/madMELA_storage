...
C     
C     Process: s s~ > e+ e- e+ e- WEIGHTED<=8 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFS2_3(W(1,3),W(1,4),GC_678,MDL_MH,MDL_WH,W(1,8))
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV1_3_3(W(1,1),W(1,2),GC_195,-GC_135,MDL_MZ,MDL_WZ,W(1,11))
      CALL FFV1_3_2(W(1,5),W(1,11),GC_197,-GC_135,MDL_ME,ZERO,W(1,12))
C     Amplitude(s) for diagram number 3
      CALL FFS2_0(W(1,12),W(1,6),W(1,8),GC_678,AMP(3))
      CALL FFV1_3_1(W(1,6),W(1,11),GC_197,-GC_135,MDL_ME,ZERO,W(1,13))
C     Amplitude(s) for diagram number 4
      CALL FFS2_0(W(1,5),W(1,13),W(1,8),GC_678,AMP(4))
      CALL FFS2_3(W(1,1),W(1,2),GC_868,MDL_MH,MDL_WH,W(1,14))
      CALL FFV1P0_3(W(1,3),W(1,4),-GC_3,ZERO,ZERO,W(1,15))
      CALL FFS2_2(W(1,5),W(1,14),GC_678,MDL_ME,ZERO,W(1,16))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,16),W(1,6),W(1,15),-GC_3,AMP(5))
      CALL FFS2_1(W(1,6),W(1,14),GC_678,MDL_ME,ZERO,W(1,17))
...
C     Amplitude(s) for diagram number 9
      CALL FFS2_0(W(1,16),W(1,6),W(1,8),GC_678,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFS2_0(W(1,5),W(1,17),W(1,8),GC_678,AMP(10))
...
C     Amplitude(s) for diagram number 14
      ...
      CALL FFS2_3(W(1,3),W(1,6),GC_678,MDL_MH,MDL_WH,W(1,21))
      CALL FFV1_1(W(1,4),W(1,7),-GC_3,MDL_ME,ZERO,W(1,22))
C     Amplitude(s) for diagram number 15
      CALL FFS2_0(W(1,5),W(1,22),W(1,21),GC_678,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL FFS2_0(W(1,9),W(1,4),W(1,21),GC_678,AMP(16))
      CALL FFV1_3_1(W(1,4),W(1,11),GC_197,-GC_135,MDL_ME,ZERO,W(1,9))
C     Amplitude(s) for diagram number 17
      CALL FFS2_0(W(1,5),W(1,9),W(1,21),GC_678,AMP(17))
C     Amplitude(s) for diagram number 18
      CALL FFS2_0(W(1,12),W(1,4),W(1,21),GC_678,AMP(18))
      CALL FFV1P0_3(W(1,3),W(1,6),-GC_3,ZERO,ZERO,W(1,12))
      CALL FFS2_1(W(1,4),W(1,14),GC_678,MDL_ME,ZERO,W(1,23))
...
C     Amplitude(s) for diagram number 23
      CALL FFS2_0(W(1,5),W(1,23),W(1,21),GC_678,AMP(23))
C     Amplitude(s) for diagram number 24
      CALL FFS2_0(W(1,16),W(1,4),W(1,21),GC_678,AMP(24))
      CALL FFS2_3(W(1,5),W(1,4),GC_678,MDL_MH,MDL_WH,W(1,16))
...
C     Amplitude(s) for diagram number 28
      ...
      CALL FFV1_2(W(1,3),W(1,7),-GC_3,MDL_ME,ZERO,W(1,26))
C     Amplitude(s) for diagram number 29
      CALL FFS2_0(W(1,26),W(1,6),W(1,16),GC_678,AMP(29))
C     Amplitude(s) for diagram number 30
      CALL FFS2_0(W(1,3),W(1,10),W(1,16),GC_678,AMP(30))
      CALL FFV1_3_2(W(1,3),W(1,11),GC_197,-GC_135,MDL_ME,ZERO,W(1,10))
C     Amplitude(s) for diagram number 31
      CALL FFS2_0(W(1,10),W(1,6),W(1,16),GC_678,AMP(31))
C     Amplitude(s) for diagram number 32
      CALL FFS2_0(W(1,3),W(1,13),W(1,16),GC_678,AMP(32))
      CALL FFV1P0_3(W(1,5),W(1,4),-GC_3,ZERO,ZERO,W(1,13))
      CALL FFS2_2(W(1,3),W(1,14),GC_678,MDL_ME,ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 37
      CALL FFS2_0(W(1,11),W(1,6),W(1,16),GC_678,AMP(37))
C     Amplitude(s) for diagram number 38
      CALL FFS2_0(W(1,3),W(1,17),W(1,16),GC_678,AMP(38))
C     Amplitude(s) for diagram number 39
      CALL FFS2_0(W(1,26),W(1,4),W(1,19),GC_678,AMP(39))
C     Amplitude(s) for diagram number 40
      CALL FFS2_0(W(1,3),W(1,22),W(1,19),GC_678,AMP(40))
C     Amplitude(s) for diagram number 41
      CALL FFS2_0(W(1,10),W(1,4),W(1,19),GC_678,AMP(41))
C     Amplitude(s) for diagram number 42
      CALL FFS2_0(W(1,3),W(1,9),W(1,19),GC_678,AMP(42))
...
C     Amplitude(s) for diagram number 47
      CALL FFS2_0(W(1,11),W(1,4),W(1,19),GC_678,AMP(47))
C     Amplitude(s) for diagram number 48
      CALL FFS2_0(W(1,3),W(1,23),W(1,19),GC_678,AMP(48))
      CALL FFV1_2(W(1,1),W(1,15),GC_1,MDL_MS,ZERO,W(1,23))
C     Amplitude(s) for diagram number 49
      CALL FFS2_0(W(1,23),W(1,2),W(1,19),GC_868,AMP(49))
      CALL FFS2_2(W(1,1),W(1,19),GC_868,MDL_MS,ZERO,W(1,23))
C     Amplitude(s) for diagram number 50
      CALL FFV1_0(W(1,23),W(1,2),W(1,15),GC_1,AMP(50))
      CALL FFV1_3_2(W(1,1),W(1,18),GC_195,-GC_135,MDL_MS,ZERO,W(1,15))
C     Amplitude(s) for diagram number 51
      CALL FFS2_0(W(1,15),W(1,2),W(1,19),GC_868,AMP(51))
C     Amplitude(s) for diagram number 52
      CALL FFV1_3_0(W(1,23),W(1,2),W(1,18),GC_195,-GC_135,AMP(52))
      CALL FFS2_2(W(1,1),W(1,8),GC_868,MDL_MS,ZERO,W(1,18))
C     Amplitude(s) for diagram number 53
      CALL FFV1_0(W(1,18),W(1,2),W(1,9),GC_1,AMP(53))
      CALL FFV1_2(W(1,1),W(1,9),GC_1,MDL_MS,ZERO,W(1,15))
C     Amplitude(s) for diagram number 54
      CALL FFS2_0(W(1,15),W(1,2),W(1,8),GC_868,AMP(54))
C     Amplitude(s) for diagram number 55
      CALL FFV1_3_0(W(1,18),W(1,2),W(1,20),GC_195,-GC_135,AMP(55))
      CALL FFV1_3_2(W(1,1),W(1,20),GC_195,-GC_135,MDL_MS,ZERO,W(1,15))
C     Amplitude(s) for diagram number 56
      CALL FFS2_0(W(1,15),W(1,2),W(1,8),GC_868,AMP(56))
C     Amplitude(s) for diagram number 57
      CALL FFS2_0(W(1,18),W(1,2),W(1,19),GC_868,AMP(57))
C     Amplitude(s) for diagram number 58
      CALL FFS2_0(W(1,23),W(1,2),W(1,8),GC_868,AMP(58))
      CALL FFV1_2(W(1,1),W(1,12),GC_1,MDL_MS,ZERO,W(1,23))
C     Amplitude(s) for diagram number 59
      CALL FFS2_0(W(1,23),W(1,2),W(1,16),GC_868,AMP(59))
      CALL FFS2_2(W(1,1),W(1,16),GC_868,MDL_MS,ZERO,W(1,23))
C     Amplitude(s) for diagram number 60
      CALL FFV1_0(W(1,23),W(1,2),W(1,12),GC_1,AMP(60))
      CALL FFV1_3_2(W(1,1),W(1,24),GC_195,-GC_135,MDL_MS,ZERO,W(1,12))
C     Amplitude(s) for diagram number 61
      CALL FFS2_0(W(1,12),W(1,2),W(1,16),GC_868,AMP(61))
C     Amplitude(s) for diagram number 62
      CALL FFV1_3_0(W(1,23),W(1,2),W(1,24),GC_195,-GC_135,AMP(62))
      CALL FFS2_2(W(1,1),W(1,21),GC_868,MDL_MS,ZERO,W(1,24))
C     Amplitude(s) for diagram number 63
      CALL FFV1_0(W(1,24),W(1,2),W(1,13),GC_1,AMP(63))
      CALL FFV1_2(W(1,1),W(1,13),GC_1,MDL_MS,ZERO,W(1,12))
C     Amplitude(s) for diagram number 64
      CALL FFS2_0(W(1,12),W(1,2),W(1,21),GC_868,AMP(64))
C     Amplitude(s) for diagram number 65
      CALL FFV1_3_0(W(1,24),W(1,2),W(1,25),GC_195,-GC_135,AMP(65))
      CALL FFV1_3_2(W(1,1),W(1,25),GC_195,-GC_135,MDL_MS,ZERO,W(1,12))
C     Amplitude(s) for diagram number 66
      CALL FFS2_0(W(1,12),W(1,2),W(1,21),GC_868,AMP(66))
C     Amplitude(s) for diagram number 67
      CALL FFS2_0(W(1,24),W(1,2),W(1,16),GC_868,AMP(67))
C     Amplitude(s) for diagram number 68
      CALL FFS2_0(W(1,23),W(1,2),W(1,21),GC_868,AMP(68))
