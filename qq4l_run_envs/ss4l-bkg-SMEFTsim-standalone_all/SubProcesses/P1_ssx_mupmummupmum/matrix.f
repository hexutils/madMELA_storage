...
C     Amplitude(s) for diagram number 4
      ...
      CALL FFV1_3_3(W(1,1),W(1,2),GC_195,-GC_135,MDL_MZ,MDL_WZ,W(1,12))
...
C     Amplitude(s) for diagram number 32
      ...
      CALL FFV1_2(W(1,1),W(1,8),GC_1,MDL_MS,ZERO,W(1,9))
C     Amplitude(s) for diagram number 33
      CALL FFV1_0(W(1,9),W(1,2),W(1,14),GC_1,AMP(33))
      CALL FFV1_2(W(1,1),W(1,14),GC_1,MDL_MS,ZERO,W(1,3))
C     Amplitude(s) for diagram number 34
      CALL FFV1_0(W(1,3),W(1,2),W(1,8),GC_1,AMP(34))
C     Amplitude(s) for diagram number 35
      CALL FFV1_3_0(W(1,9),W(1,2),W(1,12),GC_195,-GC_135,AMP(35))
      CALL FFV1_3_2(W(1,1),W(1,12),GC_195,-GC_135,MDL_MS,ZERO,W(1,9))
C     Amplitude(s) for diagram number 36
      CALL FFV1_0(W(1,9),W(1,2),W(1,8),GC_1,AMP(36))
      CALL FFV1_3_2(W(1,1),W(1,11),GC_195,-GC_135,MDL_MS,ZERO,W(1,8))
C     Amplitude(s) for diagram number 37
      CALL FFV1_0(W(1,8),W(1,2),W(1,14),GC_1,AMP(37))
C     Amplitude(s) for diagram number 38
      CALL FFV1_3_0(W(1,3),W(1,2),W(1,11),GC_195,-GC_135,AMP(38))
C     Amplitude(s) for diagram number 39
      CALL FFV1_3_0(W(1,8),W(1,2),W(1,12),GC_195,-GC_135,AMP(39))
C     Amplitude(s) for diagram number 40
      CALL FFV1_3_0(W(1,9),W(1,2),W(1,11),GC_195,-GC_135,AMP(40))
      CALL FFV1_2(W(1,1),W(1,15),GC_1,MDL_MS,ZERO,W(1,9))
C     Amplitude(s) for diagram number 41
      CALL FFV1_0(W(1,9),W(1,2),W(1,13),GC_1,AMP(41))
      CALL FFV1_2(W(1,1),W(1,13),GC_1,MDL_MS,ZERO,W(1,11))
C     Amplitude(s) for diagram number 42
      CALL FFV1_0(W(1,11),W(1,2),W(1,15),GC_1,AMP(42))
C     Amplitude(s) for diagram number 43
      CALL FFV1_3_0(W(1,9),W(1,2),W(1,7),GC_195,-GC_135,AMP(43))
      CALL FFV1_3_2(W(1,1),W(1,7),GC_195,-GC_135,MDL_MS,ZERO,W(1,9))
C     Amplitude(s) for diagram number 44
      CALL FFV1_0(W(1,9),W(1,2),W(1,15),GC_1,AMP(44))
      CALL FFV1_3_2(W(1,1),W(1,17),GC_195,-GC_135,MDL_MS,ZERO,W(1,15))
C     Amplitude(s) for diagram number 45
      CALL FFV1_0(W(1,15),W(1,2),W(1,13),GC_1,AMP(45))
C     Amplitude(s) for diagram number 46
      CALL FFV1_3_0(W(1,11),W(1,2),W(1,17),GC_195,-GC_135,AMP(46))
C     Amplitude(s) for diagram number 47
      CALL FFV1_3_0(W(1,15),W(1,2),W(1,7),GC_195,-GC_135,AMP(47))
C     Amplitude(s) for diagram number 48
      CALL FFV1_3_0(W(1,9),W(1,2),W(1,17),GC_195,-GC_135,AMP(48))
