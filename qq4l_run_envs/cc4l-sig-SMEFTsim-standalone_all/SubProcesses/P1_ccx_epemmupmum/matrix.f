...
C     
C     Process: c c~ > e+ e- mu+ mu- WEIGHTED<=8 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 4
      ...
      CALL FFS2_3(W(1,1),W(1,2),GC_526,MDL_MH,MDL_WH,W(1,10))
...
C     Amplitude(s) for diagram number 24
      ...
      CALL FFV1_2(W(1,1),W(1,11),GC_2,MDL_MC,ZERO,W(1,5))
C     Amplitude(s) for diagram number 25
      CALL FFS2_0(W(1,5),W(1,2),W(1,13),GC_526,AMP(25))
      CALL FFS2_2(W(1,1),W(1,13),GC_526,MDL_MC,ZERO,W(1,5))
C     Amplitude(s) for diagram number 26
      CALL FFV1_0(W(1,5),W(1,2),W(1,11),GC_2,AMP(26))
      CALL FFV1_3_2(W(1,1),W(1,14),GC_196,GC_135,MDL_MC,ZERO,W(1,11))
C     Amplitude(s) for diagram number 27
      CALL FFS2_0(W(1,11),W(1,2),W(1,13),GC_526,AMP(27))
C     Amplitude(s) for diagram number 28
      CALL FFV1_3_0(W(1,5),W(1,2),W(1,14),GC_196,GC_135,AMP(28))
      CALL FFS2_2(W(1,1),W(1,8),GC_526,MDL_MC,ZERO,W(1,14))
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,14),W(1,2),W(1,15),GC_2,AMP(29))
      CALL FFV1_2(W(1,1),W(1,15),GC_2,MDL_MC,ZERO,W(1,11))
C     Amplitude(s) for diagram number 30
      CALL FFS2_0(W(1,11),W(1,2),W(1,8),GC_526,AMP(30))
C     Amplitude(s) for diagram number 31
      CALL FFV1_3_0(W(1,14),W(1,2),W(1,12),GC_196,GC_135,AMP(31))
      CALL FFV1_3_2(W(1,1),W(1,12),GC_196,GC_135,MDL_MC,ZERO,W(1,11))
C     Amplitude(s) for diagram number 32
      CALL FFS2_0(W(1,11),W(1,2),W(1,8),GC_526,AMP(32))
C     Amplitude(s) for diagram number 33
      CALL FFS2_0(W(1,14),W(1,2),W(1,13),GC_526,AMP(33))
C     Amplitude(s) for diagram number 34
      CALL FFS2_0(W(1,5),W(1,2),W(1,8),GC_526,AMP(34))
