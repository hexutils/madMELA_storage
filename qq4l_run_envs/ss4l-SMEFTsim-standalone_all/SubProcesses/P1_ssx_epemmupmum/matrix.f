...
C     Amplitude(s) for diagram number 12
      ...
      CALL FFS2_3(W(1,1),W(1,2),GC_868,MDL_MH,MDL_WH,W(1,13))
...
C     Amplitude(s) for diagram number 40
      ...
      CALL FFV1_2(W(1,1),W(1,8),GC_1,MDL_MS,ZERO,W(1,5))
C     Amplitude(s) for diagram number 41
      CALL FFV1_0(W(1,5),W(1,2),W(1,15),GC_1,AMP(41))
      CALL FFV1_2(W(1,1),W(1,15),GC_1,MDL_MS,ZERO,W(1,3))
...
C     Amplitude(s) for diagram number 43
      ...
      CALL FFV1_3_2(W(1,1),W(1,9),GC_195,-GC_135,MDL_MS,ZERO,W(1,6))
C     Amplitude(s) for diagram number 44
      CALL FFV1_0(W(1,6),W(1,2),W(1,8),GC_1,AMP(44))
C     Amplitude(s) for diagram number 45
      CALL FFS2_0(W(1,5),W(1,2),W(1,14),GC_868,AMP(45))
      CALL FFS2_2(W(1,1),W(1,14),GC_868,MDL_MS,ZERO,W(1,5))
...
C     Amplitude(s) for diagram number 51
      CALL FFS2_0(W(1,8),W(1,2),W(1,14),GC_868,AMP(51))
...
C     Amplitude(s) for diagram number 54
      CALL FFS2_0(W(1,3),W(1,2),W(1,12),GC_868,AMP(54))
...
C     Amplitude(s) for diagram number 56
      CALL FFS2_0(W(1,6),W(1,2),W(1,12),GC_868,AMP(56))
C     Amplitude(s) for diagram number 57
      CALL FFS2_0(W(1,11),W(1,2),W(1,14),GC_868,AMP(57))
C     Amplitude(s) for diagram number 58
      CALL FFS2_0(W(1,5),W(1,2),W(1,12),GC_868,AMP(58))
