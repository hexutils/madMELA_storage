...
C     
C     Process: s s~ > mu+ mu- mu+ mu- WEIGHTED<=8 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 4
      ...
      CALL FFS2_3(W(1,3),W(1,4),GC_773,MDL_MH,MDL_WH,W(1,12))
C     Amplitude(s) for diagram number 5
      CALL FFS2_0(W(1,9),W(1,6),W(1,12),GC_773,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFS2_0(W(1,5),W(1,10),W(1,12),GC_773,AMP(6))
      CALL FFV1_3_3(W(1,1),W(1,2),GC_195,-GC_135,MDL_MZ,MDL_WZ,W(1,13))
      CALL FFV1_3_2(W(1,5),W(1,13),GC_197,-GC_135,MDL_MMU,ZERO,W(1,14))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,14),W(1,6),W(1,8),-GC_3,AMP(7))
      CALL FFV1_3_1(W(1,6),W(1,13),GC_197,-GC_135,MDL_MMU,ZERO,W(1,15))
...
C     Amplitude(s) for diagram number 11
      CALL FFS2_0(W(1,14),W(1,6),W(1,12),GC_773,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFS2_0(W(1,5),W(1,15),W(1,12),GC_773,AMP(12))
      CALL FFS2_3(W(1,1),W(1,2),GC_868,MDL_MH,MDL_WH,W(1,16))
      CALL FFS2_2(W(1,5),W(1,16),GC_773,MDL_MMU,ZERO,W(1,17))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,17),W(1,6),W(1,8),-GC_3,AMP(13))
      CALL FFS2_1(W(1,6),W(1,16),GC_773,MDL_MMU,ZERO,W(1,18))
...
C     Amplitude(s) for diagram number 17
      CALL FFS2_0(W(1,17),W(1,6),W(1,12),GC_773,AMP(17))
C     Amplitude(s) for diagram number 18
      CALL FFS2_0(W(1,5),W(1,18),W(1,12),GC_773,AMP(18))
...
C     Amplitude(s) for diagram number 26
      ...
      CALL FFS2_3(W(1,3),W(1,6),GC_773,MDL_MH,MDL_WH,W(1,24))
C     Amplitude(s) for diagram number 27
      CALL FFS2_0(W(1,5),W(1,22),W(1,24),GC_773,AMP(27))
C     Amplitude(s) for diagram number 28
      CALL FFS2_0(W(1,9),W(1,4),W(1,24),GC_773,AMP(28))
      CALL FFV1_3_1(W(1,4),W(1,13),GC_197,-GC_135,MDL_MMU,ZERO,W(1,9))
...
C     Amplitude(s) for diagram number 33
      CALL FFS2_0(W(1,5),W(1,9),W(1,24),GC_773,AMP(33))
C     Amplitude(s) for diagram number 34
      CALL FFS2_0(W(1,14),W(1,4),W(1,24),GC_773,AMP(34))
      CALL FFS2_1(W(1,4),W(1,16),GC_773,MDL_MMU,ZERO,W(1,14))
...
C     Amplitude(s) for diagram number 39
      CALL FFS2_0(W(1,5),W(1,14),W(1,24),GC_773,AMP(39))
C     Amplitude(s) for diagram number 40
      CALL FFS2_0(W(1,17),W(1,4),W(1,24),GC_773,AMP(40))
      CALL FFS2_3(W(1,5),W(1,4),GC_773,MDL_MH,MDL_WH,W(1,17))
...
C     Amplitude(s) for diagram number 44
      ...
      CALL FFV1_2(W(1,3),W(1,7),-GC_3,MDL_MMU,ZERO,W(1,27))
...
C     Amplitude(s) for diagram number 49
      CALL FFS2_0(W(1,27),W(1,6),W(1,17),GC_773,AMP(49))
C     Amplitude(s) for diagram number 50
      CALL FFS2_0(W(1,3),W(1,10),W(1,17),GC_773,AMP(50))
      CALL FFV1_3_2(W(1,3),W(1,13),GC_197,-GC_135,MDL_MMU,ZERO,W(1,10))
...
C     Amplitude(s) for diagram number 55
      CALL FFS2_0(W(1,10),W(1,6),W(1,17),GC_773,AMP(55))
C     Amplitude(s) for diagram number 56
      CALL FFS2_0(W(1,3),W(1,15),W(1,17),GC_773,AMP(56))
      CALL FFS2_2(W(1,3),W(1,16),GC_773,MDL_MMU,ZERO,W(1,15))
...
C     Amplitude(s) for diagram number 61
      CALL FFS2_0(W(1,15),W(1,6),W(1,17),GC_773,AMP(61))
C     Amplitude(s) for diagram number 62
      CALL FFS2_0(W(1,3),W(1,18),W(1,17),GC_773,AMP(62))
...
C     Amplitude(s) for diagram number 67
      CALL FFS2_0(W(1,27),W(1,4),W(1,19),GC_773,AMP(67))
C     Amplitude(s) for diagram number 68
      CALL FFS2_0(W(1,3),W(1,22),W(1,19),GC_773,AMP(68))
...
C     Amplitude(s) for diagram number 73
      CALL FFS2_0(W(1,10),W(1,4),W(1,19),GC_773,AMP(73))
C     Amplitude(s) for diagram number 74
      CALL FFS2_0(W(1,3),W(1,9),W(1,19),GC_773,AMP(74))
...
C     Amplitude(s) for diagram number 79
      CALL FFS2_0(W(1,15),W(1,4),W(1,19),GC_773,AMP(79))
C     Amplitude(s) for diagram number 80
      CALL FFS2_0(W(1,3),W(1,14),W(1,19),GC_773,AMP(80))
      CALL FFV1_2(W(1,1),W(1,8),GC_1,MDL_MS,ZERO,W(1,14))
C     Amplitude(s) for diagram number 81
      CALL FFV1_0(W(1,14),W(1,2),W(1,18),GC_1,AMP(81))
      CALL FFV1_2(W(1,1),W(1,18),GC_1,MDL_MS,ZERO,W(1,3))
C     Amplitude(s) for diagram number 82
      CALL FFV1_0(W(1,3),W(1,2),W(1,8),GC_1,AMP(82))
C     Amplitude(s) for diagram number 83
      CALL FFV1_3_0(W(1,14),W(1,2),W(1,20),GC_195,-GC_135,AMP(83))
      CALL FFV1_3_2(W(1,1),W(1,20),GC_195,-GC_135,MDL_MS,ZERO,W(1,15))
C     Amplitude(s) for diagram number 84
      CALL FFV1_0(W(1,15),W(1,2),W(1,8),GC_1,AMP(84))
C     Amplitude(s) for diagram number 85
      CALL FFS2_0(W(1,14),W(1,2),W(1,19),GC_868,AMP(85))
      CALL FFS2_2(W(1,1),W(1,19),GC_868,MDL_MS,ZERO,W(1,14))
C     Amplitude(s) for diagram number 86
      CALL FFV1_0(W(1,14),W(1,2),W(1,8),GC_1,AMP(86))
      CALL FFV1_3_2(W(1,1),W(1,11),GC_195,-GC_135,MDL_MS,ZERO,W(1,8))
C     Amplitude(s) for diagram number 87
      CALL FFV1_0(W(1,8),W(1,2),W(1,18),GC_1,AMP(87))
C     Amplitude(s) for diagram number 88
      CALL FFV1_3_0(W(1,3),W(1,2),W(1,11),GC_195,-GC_135,AMP(88))
C     Amplitude(s) for diagram number 89
      CALL FFV1_3_0(W(1,8),W(1,2),W(1,20),GC_195,-GC_135,AMP(89))
C     Amplitude(s) for diagram number 90
      CALL FFV1_3_0(W(1,15),W(1,2),W(1,11),GC_195,-GC_135,AMP(90))
C     Amplitude(s) for diagram number 91
      CALL FFS2_0(W(1,8),W(1,2),W(1,19),GC_868,AMP(91))
C     Amplitude(s) for diagram number 92
      CALL FFV1_3_0(W(1,14),W(1,2),W(1,11),GC_195,-GC_135,AMP(92))
      CALL FFS2_2(W(1,1),W(1,12),GC_868,MDL_MS,ZERO,W(1,11))
C     Amplitude(s) for diagram number 93
      CALL FFV1_0(W(1,11),W(1,2),W(1,18),GC_1,AMP(93))
C     Amplitude(s) for diagram number 94
      CALL FFS2_0(W(1,3),W(1,2),W(1,12),GC_868,AMP(94))
C     Amplitude(s) for diagram number 95
      CALL FFV1_3_0(W(1,11),W(1,2),W(1,20),GC_195,-GC_135,AMP(95))
C     Amplitude(s) for diagram number 96
      CALL FFS2_0(W(1,15),W(1,2),W(1,12),GC_868,AMP(96))
C     Amplitude(s) for diagram number 97
      CALL FFS2_0(W(1,11),W(1,2),W(1,19),GC_868,AMP(97))
C     Amplitude(s) for diagram number 98
      CALL FFS2_0(W(1,14),W(1,2),W(1,12),GC_868,AMP(98))
      CALL FFV1_2(W(1,1),W(1,21),GC_1,MDL_MS,ZERO,W(1,14))
C     Amplitude(s) for diagram number 99
      CALL FFV1_0(W(1,14),W(1,2),W(1,26),GC_1,AMP(99))
      CALL FFV1_2(W(1,1),W(1,26),GC_1,MDL_MS,ZERO,W(1,12))
C     Amplitude(s) for diagram number 100
      CALL FFV1_0(W(1,12),W(1,2),W(1,21),GC_1,AMP(100))
C     Amplitude(s) for diagram number 101
      CALL FFV1_3_0(W(1,14),W(1,2),W(1,25),GC_195,-GC_135,AMP(101))
      CALL FFV1_3_2(W(1,1),W(1,25),GC_195,-GC_135,MDL_MS,ZERO,W(1,11))
C     Amplitude(s) for diagram number 102
      CALL FFV1_0(W(1,11),W(1,2),W(1,21),GC_1,AMP(102))
C     Amplitude(s) for diagram number 103
      CALL FFS2_0(W(1,14),W(1,2),W(1,17),GC_868,AMP(103))
      CALL FFS2_2(W(1,1),W(1,17),GC_868,MDL_MS,ZERO,W(1,14))
C     Amplitude(s) for diagram number 104
      CALL FFV1_0(W(1,14),W(1,2),W(1,21),GC_1,AMP(104))
      CALL FFV1_3_2(W(1,1),W(1,23),GC_195,-GC_135,MDL_MS,ZERO,W(1,21))
C     Amplitude(s) for diagram number 105
      CALL FFV1_0(W(1,21),W(1,2),W(1,26),GC_1,AMP(105))
C     Amplitude(s) for diagram number 106
      CALL FFV1_3_0(W(1,12),W(1,2),W(1,23),GC_195,-GC_135,AMP(106))
C     Amplitude(s) for diagram number 107
      CALL FFV1_3_0(W(1,21),W(1,2),W(1,25),GC_195,-GC_135,AMP(107))
C     Amplitude(s) for diagram number 108
      CALL FFV1_3_0(W(1,11),W(1,2),W(1,23),GC_195,-GC_135,AMP(108))
C     Amplitude(s) for diagram number 109
      CALL FFS2_0(W(1,21),W(1,2),W(1,17),GC_868,AMP(109))
C     Amplitude(s) for diagram number 110
      CALL FFV1_3_0(W(1,14),W(1,2),W(1,23),GC_195,-GC_135,AMP(110))
      CALL FFS2_2(W(1,1),W(1,24),GC_868,MDL_MS,ZERO,W(1,23))
C     Amplitude(s) for diagram number 111
      CALL FFV1_0(W(1,23),W(1,2),W(1,26),GC_1,AMP(111))
C     Amplitude(s) for diagram number 112
      CALL FFS2_0(W(1,12),W(1,2),W(1,24),GC_868,AMP(112))
C     Amplitude(s) for diagram number 113
      CALL FFV1_3_0(W(1,23),W(1,2),W(1,25),GC_195,-GC_135,AMP(113))
C     Amplitude(s) for diagram number 114
      CALL FFS2_0(W(1,11),W(1,2),W(1,24),GC_868,AMP(114))
C     Amplitude(s) for diagram number 115
      CALL FFS2_0(W(1,23),W(1,2),W(1,17),GC_868,AMP(115))
C     Amplitude(s) for diagram number 116
      CALL FFS2_0(W(1,14),W(1,2),W(1,24),GC_868,AMP(116))
