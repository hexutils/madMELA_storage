...
C     Amplitude(s) for diagram number 17
      ...
      CALL FFV1_2(W(1,1),W(1,12),GC_2,MDL_MC,ZERO,W(1,3))
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,3),W(1,2),W(1,8),GC_2,AMP(18))
C     Amplitude(s) for diagram number 19
      CALL FFV1_3_0(W(1,9),W(1,2),W(1,7),GC_196,GC_135,AMP(19))
...
C     Amplitude(s) for diagram number 22
      CALL FFV1_3_0(W(1,3),W(1,2),W(1,11),GC_196,GC_135,AMP(22))
C     Amplitude(s) for diagram number 23
      CALL FFV1_3_0(W(1,8),W(1,2),W(1,7),GC_196,GC_135,AMP(23))
C     Amplitude(s) for diagram number 24
      CALL FFV1_3_0(W(1,9),W(1,2),W(1,11),GC_196,GC_135,AMP(24))
