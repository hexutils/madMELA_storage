...
C     
C     Process: c c~ > e+ e- e+ e- WEIGHTED<=8 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 4
      ...
      CALL FFV1_3_2(W(1,5),W(1,12),GC_197,-GC_135,MDL_ME,ZERO,W(1,13))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,13),W(1,6),W(1,8),-GC_3,AMP(5))
      CALL FFV1_3_1(W(1,6),W(1,12),GC_197,-GC_135,MDL_ME,ZERO,W(1,14))
...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFV1_1(W(1,4),W(1,7),-GC_3,MDL_ME,ZERO,W(1,16))
...
C     Amplitude(s) for diagram number 12
      ...
      CALL FFV1_3_1(W(1,4),W(1,12),GC_197,-GC_135,MDL_ME,ZERO,W(1,9))
...
C     Amplitude(s) for diagram number 16
      ...
      CALL FFV1_2(W(1,3),W(1,7),-GC_3,MDL_ME,ZERO,W(1,18))
...
C     Amplitude(s) for diagram number 20
      ...
      CALL FFV1_3_2(W(1,3),W(1,12),GC_197,-GC_135,MDL_ME,ZERO,W(1,10))
