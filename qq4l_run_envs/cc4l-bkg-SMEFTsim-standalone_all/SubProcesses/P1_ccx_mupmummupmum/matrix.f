...
C     
C     Process: c c~ > mu+ mu- mu+ mu- WEIGHTED<=8 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 4
      ...
      CALL FFV1_3_3(W(1,1),W(1,2),GC_196,GC_135,MDL_MZ,MDL_WZ,W(1,12))
      CALL FFV1_3_2(W(1,5),W(1,12),GC_197,-GC_135,MDL_MMU,ZERO,W(1,13))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,13),W(1,6),W(1,8),-GC_3,AMP(5))
      CALL FFV1_3_1(W(1,6),W(1,12),GC_197,-GC_135,MDL_MMU,ZERO,W(1,14))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,5),W(1,14),W(1,8),-GC_3,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL FFV1_3_0(W(1,13),W(1,6),W(1,11),GC_197,-GC_135,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV1_3_0(W(1,5),W(1,14),W(1,11),GC_197,-GC_135,AMP(8))
      CALL FFV1P0_3(W(1,3),W(1,6),-GC_3,ZERO,ZERO,W(1,15))
      CALL FFV1_1(W(1,4),W(1,7),-GC_3,MDL_MMU,ZERO,W(1,16))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,5),W(1,16),W(1,15),-GC_3,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,9),W(1,4),W(1,15),-GC_3,AMP(10))
      CALL FFV1_3_3(W(1,3),W(1,6),GC_197,-GC_135,MDL_MZ,MDL_WZ,W(1,17))
C     Amplitude(s) for diagram number 11
      CALL FFV1_3_0(W(1,5),W(1,16),W(1,17),GC_197,-GC_135,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV1_3_0(W(1,9),W(1,4),W(1,17),GC_197,-GC_135,AMP(12))
      CALL FFV1_3_1(W(1,4),W(1,12),GC_197,-GC_135,MDL_MMU,ZERO,W(1,9))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,5),W(1,9),W(1,15),-GC_3,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,13),W(1,4),W(1,15),-GC_3,AMP(14))
C     Amplitude(s) for diagram number 15
      CALL FFV1_3_0(W(1,5),W(1,9),W(1,17),GC_197,-GC_135,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL FFV1_3_0(W(1,13),W(1,4),W(1,17),GC_197,-GC_135,AMP(16))
      CALL FFV1P0_3(W(1,5),W(1,4),-GC_3,ZERO,ZERO,W(1,13))
      CALL FFV1_2(W(1,3),W(1,7),-GC_3,MDL_MMU,ZERO,W(1,18))
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,18),W(1,6),W(1,13),-GC_3,AMP(17))
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,3),W(1,10),W(1,13),-GC_3,AMP(18))
      CALL FFV1_3_3(W(1,5),W(1,4),GC_197,-GC_135,MDL_MZ,MDL_WZ,W(1,7))
C     Amplitude(s) for diagram number 19
      CALL FFV1_3_0(W(1,18),W(1,6),W(1,7),GC_197,-GC_135,AMP(19))
C     Amplitude(s) for diagram number 20
      CALL FFV1_3_0(W(1,3),W(1,10),W(1,7),GC_197,-GC_135,AMP(20))
      CALL FFV1_3_2(W(1,3),W(1,12),GC_197,-GC_135,MDL_MMU,ZERO,W(1,10))
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,10),W(1,6),W(1,13),-GC_3,AMP(21))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,3),W(1,14),W(1,13),-GC_3,AMP(22))
C     Amplitude(s) for diagram number 23
      CALL FFV1_3_0(W(1,10),W(1,6),W(1,7),GC_197,-GC_135,AMP(23))
C     Amplitude(s) for diagram number 24
      CALL FFV1_3_0(W(1,3),W(1,14),W(1,7),GC_197,-GC_135,AMP(24))
      CALL FFV1P0_3(W(1,5),W(1,6),-GC_3,ZERO,ZERO,W(1,14))
C     Amplitude(s) for diagram number 25
      CALL FFV1_0(W(1,18),W(1,4),W(1,14),-GC_3,AMP(25))
C     Amplitude(s) for diagram number 26
      CALL FFV1_0(W(1,3),W(1,16),W(1,14),-GC_3,AMP(26))
      CALL FFV1_3_3(W(1,5),W(1,6),GC_197,-GC_135,MDL_MZ,MDL_WZ,W(1,12))
C     Amplitude(s) for diagram number 27
      CALL FFV1_3_0(W(1,18),W(1,4),W(1,12),GC_197,-GC_135,AMP(27))
C     Amplitude(s) for diagram number 28
      CALL FFV1_3_0(W(1,3),W(1,16),W(1,12),GC_197,-GC_135,AMP(28))
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,10),W(1,4),W(1,14),-GC_3,AMP(29))
C     Amplitude(s) for diagram number 30
      CALL FFV1_0(W(1,3),W(1,9),W(1,14),-GC_3,AMP(30))
C     Amplitude(s) for diagram number 31
      CALL FFV1_3_0(W(1,10),W(1,4),W(1,12),GC_197,-GC_135,AMP(31))
C     Amplitude(s) for diagram number 32
      CALL FFV1_3_0(W(1,3),W(1,9),W(1,12),GC_197,-GC_135,AMP(32))
      CALL FFV1_2(W(1,1),W(1,8),GC_2,MDL_MC,ZERO,W(1,9))
C     Amplitude(s) for diagram number 33
      CALL FFV1_0(W(1,9),W(1,2),W(1,14),GC_2,AMP(33))
      CALL FFV1_2(W(1,1),W(1,14),GC_2,MDL_MC,ZERO,W(1,3))
C     Amplitude(s) for diagram number 34
      CALL FFV1_0(W(1,3),W(1,2),W(1,8),GC_2,AMP(34))
C     Amplitude(s) for diagram number 35
      CALL FFV1_3_0(W(1,9),W(1,2),W(1,12),GC_196,GC_135,AMP(35))
      CALL FFV1_3_2(W(1,1),W(1,12),GC_196,GC_135,MDL_MC,ZERO,W(1,9))
C     Amplitude(s) for diagram number 36
      CALL FFV1_0(W(1,9),W(1,2),W(1,8),GC_2,AMP(36))
      CALL FFV1_3_2(W(1,1),W(1,11),GC_196,GC_135,MDL_MC,ZERO,W(1,8))
C     Amplitude(s) for diagram number 37
      CALL FFV1_0(W(1,8),W(1,2),W(1,14),GC_2,AMP(37))
C     Amplitude(s) for diagram number 38
      CALL FFV1_3_0(W(1,3),W(1,2),W(1,11),GC_196,GC_135,AMP(38))
C     Amplitude(s) for diagram number 39
      CALL FFV1_3_0(W(1,8),W(1,2),W(1,12),GC_196,GC_135,AMP(39))
C     Amplitude(s) for diagram number 40
      CALL FFV1_3_0(W(1,9),W(1,2),W(1,11),GC_196,GC_135,AMP(40))
      CALL FFV1_2(W(1,1),W(1,15),GC_2,MDL_MC,ZERO,W(1,9))
C     Amplitude(s) for diagram number 41
      CALL FFV1_0(W(1,9),W(1,2),W(1,13),GC_2,AMP(41))
      CALL FFV1_2(W(1,1),W(1,13),GC_2,MDL_MC,ZERO,W(1,11))
C     Amplitude(s) for diagram number 42
      CALL FFV1_0(W(1,11),W(1,2),W(1,15),GC_2,AMP(42))
C     Amplitude(s) for diagram number 43
      CALL FFV1_3_0(W(1,9),W(1,2),W(1,7),GC_196,GC_135,AMP(43))
      CALL FFV1_3_2(W(1,1),W(1,7),GC_196,GC_135,MDL_MC,ZERO,W(1,9))
C     Amplitude(s) for diagram number 44
      CALL FFV1_0(W(1,9),W(1,2),W(1,15),GC_2,AMP(44))
      CALL FFV1_3_2(W(1,1),W(1,17),GC_196,GC_135,MDL_MC,ZERO,W(1,15))
C     Amplitude(s) for diagram number 45
      CALL FFV1_0(W(1,15),W(1,2),W(1,13),GC_2,AMP(45))
C     Amplitude(s) for diagram number 46
      CALL FFV1_3_0(W(1,11),W(1,2),W(1,17),GC_196,GC_135,AMP(46))
C     Amplitude(s) for diagram number 47
      CALL FFV1_3_0(W(1,15),W(1,2),W(1,7),GC_196,GC_135,AMP(47))
C     Amplitude(s) for diagram number 48
      CALL FFV1_3_0(W(1,9),W(1,2),W(1,17),GC_196,GC_135,AMP(48))
